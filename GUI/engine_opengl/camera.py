# Modified, my changes commented with 2 hashes
...
class Camera(object):
    ...
    def __init__(self, solidBsp):
        ...
        # move
        self.moveSpeed = .18                        ## change this value to better sync with the cybot
        self.moveDir = [0, 0] # x,y or strafe/fwd
        self.worldPos = [0, 0, 0] # x, y, z
        # look
        self.lookSpeed = .19                        ## this can also be modified, but there is also a multiplier in the turn functions
        self.pitch = 0
    ...
    def setYawDeg(self, yawDeg):
        self.yawDelta = yawDeg / self.lookSpeed
    ...
    ## the multiplier in these 2 can be changed to sync the turn speed ##
    def rotateLeft(self):
        self.yawDelta -= 11.9 * self.lookSpeed
